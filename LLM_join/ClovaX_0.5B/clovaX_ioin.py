...
VECTOR_STORE_PATH = "C:\code\medical_clovaX"  # index.faiss, index.pkl 있는 경로 설정
OLLAMA_MODEL_NAME = "HyperCLOVAX-SEED-Text-Instruct-0.5B"   # LLM 연결에 사용할 모델
...
# --- 4. LLM 로드 (HyperCLOVAX 0.5B) ---
try:
    logger.info("HyperCLOVAX-SEED-Text-Instruct-0.5B 모델을 Hugging Face에서 로드 중...")
    ...
    model = AutoModelForCausalLM.from_pretrained(
        model_name_or_path,
        device_map="auto",          # GPU 자동 선택
        torch_dtype="auto"          # 또는 torch.float16 사용 가능
    )
